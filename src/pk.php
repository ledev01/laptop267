...
<div class="flex felx-row gap-x-2 mb-4 mt-4 max-w-5xl mx-auto ">
    ...
    <p class="font-mono underline text-blue-500">Phụ kiện</p>
</div>
<div class="grid grid-cols-4 max-w-5xl mx-auto gap-x-12 gap-y-10">
    ...
    foreach ($sphome2 as $sp) {
        ...
        echo '
        <div class="relative hover:scale-105 transition-transform duration-300 w-56 h-[470px] bg-yellow-100 rounded-md shadow-xl flex flex-col mt-8">
